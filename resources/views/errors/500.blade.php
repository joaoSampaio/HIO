...
<html>
  ...
  @media screen and (max-width: 450px) {
    ...
    .border-button {
      color: rgba(235, 25, 70, 1) !important;
      border-color: rgba(235, 25, 70, 1) !important;
    }
    .button {
      background-color: rgba(235, 25, 70, 1) !important;
...
<div class="content-container shadow">
  ...
  <div class="context secondary-text-color">
	...
	<div class="buttons-container single-button">
		<a class="button" href="/" target="_blank"><span class="fa fa-warning"></span> Return to Homepage</a>
	</div>
</div>
